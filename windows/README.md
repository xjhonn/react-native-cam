...
There are two implementations of `react-native-cam` in this folder:
...
In addition, `react-native-cam` targets React Native 0.59 and doesn't include React Native Windows as a dependency. So in order to build _ReactNativeCameraCPP_ locally you'll need to temporarily upgrade the development dependencies:
