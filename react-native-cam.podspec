...
Pod::Spec.new do |s|
  ...
  s.source         = { :git => 'https://github.com/react-native-community/react-native-cam', :tag => "v#{s.version}" }
  ...
  s.subspec "TextDetector" do |ss|
    ss.dependency 'react-native-cam/RN'
    ss.dependency 'react-native-cam/RCT'
